...
if __name__ == "__main__":
    ...
    #files = dict(dict_file = "dictd_www.freedict.de_spa-eng.dict.dz", idx_file = "dictd_www.freedict.de_spa-eng.idx", ifo_file = "dictd_www.freedict.de_spa-eng.ifo")
    files = dict(dict_file = "dictd_www.freedict.de_eng-spa.dict.dz", idx_file = "dictd_www.freedict.de_eng-spa.idx", ifo_file = "dictd_www.freedict.de_eng-spa.ifo")
