...
def change_timeout(timeout) :
    ...
    if r.status_code not in [200, 201] :
        raise Exception("Failed to lookup configuration: " + str(r.status_code) + " to: " + couch_config + "_config")
...
try :
    tests = [
               ...
               { "loc" : "/api?human=0&alien=usersearch&keyword=m", "method" : "get", "success" : True, "test_success" : True },
